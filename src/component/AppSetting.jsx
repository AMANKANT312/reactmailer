  ...
  return (
    <div>
      <div className="w-screen h-screen bg-[#4340406e] fixed z-10 backdrop-blur-[1px] flex justify-center items-center ">
        <div className="w-[400px] rounded-lg overflow-hidden h-[520px]  bg-[#be3745ed]  flex  items-center flex-col">
          ...
          <div className="head w-full h-10 flex bg-[#272260] pl-8 items-center gap-3 pb-1 mb-1 pt-1 text-white">
            <div
          ...
          <div className="flex justify-around w-full my-1">
            ...
            <div className="flex justify-between w-[80px] bg-slate-50  px-2 items-center">
              <div className="w-4 h-4 bg-green-900 rounded-full text-cente flex items-center justify-center">
                v
              </div>
              <div>Ok</div>
            </div>
